...
#mutate to create column with discharge in meters cubed per second. Also mutate with rollmean function to get a 30-day rolling mean of the metric discharge
